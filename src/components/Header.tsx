    ...
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200/10 dark:border-white/10 px-4 sm:px-6 lg:px-10 py-3">
      ...
      <div className="flex flex-1 justify-end items-center gap-4 md:gap-8">
        <div className="hidden md:flex items-center gap-9">
          <a
            className="text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary text-sm font-medium leading-normal transition-colors"
            href="#"
          >
            Lobby
          </a>
        ...
        <div
          ...
          style={{
            backgroundImage:
              'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCLjMNnIlFsl13nBUCg4K6TsmL_GQXWVw7ZVYiGdHLxEcsgSwYA2raqQ8iC3j3_TGZXC7m88NoZ5e__kWcuwcsawmkqAovv7yeuczyXQpDhPGsvmyyLcEhQgtd4vJ05ploqkTY7gwUjV3uk971d3hNZJg3fxuAm1Mm3-QC9cM3p6IzR741ZQ4dipOGpz3mcWUaKhYspl0l3k78pEhEenISfq60OpxKDw125nnse8YJISRlIsQzxGUXeirnNgBvCcz1lzLyyJwfmgE4")',
          }}
        ></div>
      </div>
    </header>
